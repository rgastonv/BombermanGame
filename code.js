...
function preload() {
    ...
    game.load.spritesheet('dude', 'assets/dude.png', 32, 48); //Cada 32 píxeles recorta un nuevo sprite horizontalmente
...
function create() {
    ...
    var bloqueLadrillo = ladrillos.create(56,game.world.height - 128,'ladrillo2');
    ...
    player.animations.add('left', [0, 1, 2, 3], 10, true); //Se crea una animación "left" con los primeros cuatro sprites de "dude", a 10 fps y con loop (true)
